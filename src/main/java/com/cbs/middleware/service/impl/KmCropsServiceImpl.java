...
/**
 * Service Implementation for managing {@link com.cbs.middleware.domain.KmCrops}.
 */
@Service
@Transactional
public class KmCropsServiceImpl implements KmCropsService {
    ...
    public Optional<KmCrops> partialUpdate(KmCrops kmCrops) {
        ...
        return kmCropsRepository
            ...
            .map(existingKmCrops -> {
                if (kmCrops.getCropName() != null) {
                    existingKmCrops.setCropName(kmCrops.getCropName());
                }
                if (kmCrops.getCropNameMr() != null) {
                    existingKmCrops.setCropNameMr(kmCrops.getCropNameMr());
                }
                ...
                if (kmCrops.getPrviousAmt() != null) {
                    existingKmCrops.setPrviousAmt(kmCrops.getPrviousAmt());
                }
                if (kmCrops.getPreviousAmtMr() != null) {
                    existingKmCrops.setPreviousAmtMr(kmCrops.getPreviousAmtMr());
                }
