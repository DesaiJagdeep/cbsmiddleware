...
export class KmMasterUpdateComponent implements OnInit {
  ...
  farmerTypeMastersCollection: IFarmerTypeMaster[] = [];
  ...
  protected updateForm(kmMaster: IKmMaster): void {
    ...
    this.farmerTypeMastersCollection = this.farmerTypeMasterService.addFarmerTypeMasterToCollectionIfMissing<IFarmerTypeMaster>(
      this.farmerTypeMastersCollection,
  ...
  protected loadRelationshipsOptions(): void {
    this.farmerTypeMasterService
      ...
      .subscribe((farmerTypeMasters: IFarmerTypeMaster[]) => (this.farmerTypeMastersCollection = farmerTypeMasters));
  }
}
