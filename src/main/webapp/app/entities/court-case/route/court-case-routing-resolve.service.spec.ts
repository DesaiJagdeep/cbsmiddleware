...
describe('CourtCase routing resolve service', () => {
  ...
  let resultCourtCase: ICourtCase | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCourtCase).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICourtCase>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
