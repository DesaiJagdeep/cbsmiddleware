 ...
 */
@RestController
@RequestMapping("/api/crop-masters")
public class CropMasterResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<CropMaster>> getAllCropMasters(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
