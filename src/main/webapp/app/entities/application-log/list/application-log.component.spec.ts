...
describe('ApplicationLog Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'application-log', component: ApplicationLogComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.applicationLogs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to applicationLogService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getApplicationLogIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getApplicationLogIdentifier).toHaveBeenCalledWith(entity);
