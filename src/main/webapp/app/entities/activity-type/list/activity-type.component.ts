...
import { EntityArrayResponseType, ActivityTypeService } from '../service/activity-type.service';
...
export class ActivityTypeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IActivityType): number => this.activityTypeService.getActivityTypeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.activityTypes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IActivityType[] | null): IActivityType[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.activityTypeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
