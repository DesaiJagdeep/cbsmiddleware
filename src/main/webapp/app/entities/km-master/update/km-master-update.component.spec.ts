...
describe('KmMaster Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [KmMasterUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call FarmerTypeMaster query and add missing value', () => {
      ...
      const farmerTypeMaster: IFarmerTypeMaster = { id: 73287 };
      kmMaster.farmerTypeMaster = farmerTypeMaster;

      const farmerTypeMasterCollection: IFarmerTypeMaster[] = [{ id: 64638 }];
    ...
    it('Should update editForm', () => {
      const kmMaster: IKmMaster = { id: 456 };
      const farmerTypeMaster: IFarmerTypeMaster = { id: 35918 };
      kmMaster.farmerTypeMaster = farmerTypeMaster;
