...
describe('StateMaster Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'state-master', component: StateMasterComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.stateMasters?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to stateMasterService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getStateMasterIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getStateMasterIdentifier).toHaveBeenCalledWith(entity);
