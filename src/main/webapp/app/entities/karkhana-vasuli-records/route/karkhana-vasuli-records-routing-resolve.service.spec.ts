...
describe('KarkhanaVasuliRecords routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IKarkhanaVasuliRecords returned by find', () => {
      // GIVEN
      ...
      expect(resultKarkhanaVasuliRecords).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultKarkhanaVasuliRecords).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IKarkhanaVasuliRecords>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
      ...
      // THEN
      expect(service.find).toBeCalledWith(123);
      expect(resultKarkhanaVasuliRecords).toEqual(undefined);
