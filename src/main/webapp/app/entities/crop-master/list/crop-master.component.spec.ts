...
describe('CropMaster Management Component', () => {
  let comp: CropMasterComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CropMasterComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cropMasters?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to cropMasterService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCropMasterIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCropMasterIdentifier).toHaveBeenCalledWith(entity);
