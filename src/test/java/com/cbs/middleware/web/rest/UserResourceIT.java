...
import com.cbs.middleware.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    @BeforeEach
    public void setup() {
        cacheManager.getCache(UserRepository.BRANCH_USERS_BY_LOGIN_CACHE).clear();
        cacheManager.getCache(UserRepository.BRANCH_USERS_BY_EMAIL_CACHE).clear();
    }
    ...
    void createUser() throws Exception {
        ...
        managedUserVM.setAuthorities(Collections.singleton(AuthoritiesConstants.ROLE_BRANCH_USER));
    ...
    void getUser() throws Exception {
        ...
        assertThat(cacheManager.getCache(UserRepository.BRANCH_USERS_BY_LOGIN_CACHE).get(user.getLogin())).isNull();
        ...
        assertThat(cacheManager.getCache(UserRepository.BRANCH_USERS_BY_LOGIN_CACHE).get(user.getLogin())).isNotNull();
    }
    ...
    void testUserDTOtoUser() {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.ROLE_BRANCH_USER));
        ...
        assertThat(user.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.ROLE_BRANCH_USER);
    }
    ...
    void testUserToUserDTO() {
        ...
        authority.setName(AuthoritiesConstants.ROLE_BRANCH_USER);
        ...
        assertThat(userDTO.getAuthorities()).containsExactly(AuthoritiesConstants.ROLE_BRANCH_USER);
    ...
    void testAuthorityEquals() {
        ...
        authorityA.setName(AuthoritiesConstants.ROLE_BRANCH_USER);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityB.setName(AuthoritiesConstants.ROLE_BRANCH_USER);
