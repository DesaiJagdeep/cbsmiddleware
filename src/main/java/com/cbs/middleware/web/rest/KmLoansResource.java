...
public class KmLoansResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/km-loans/{id}", consumes = { "application/json", "application/merge-patch+json" })
