...
describe('BankBranchMaster Management Component', () => {
  let comp: BankBranchMasterComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'bank-branch-master', component: BankBranchMasterComponent }]),
      ...
      .overrideTemplate(BankBranchMasterComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bankBranchMasters?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to bankBranchMasterService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBankBranchMasterIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBankBranchMasterIdentifier).toHaveBeenCalledWith(entity);
