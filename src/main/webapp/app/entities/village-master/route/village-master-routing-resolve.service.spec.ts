...
describe('VillageMaster routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IVillageMaster returned by find', () => {
      // GIVEN
      ...
      expect(resultVillageMaster).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultVillageMaster).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IVillageMaster>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
      ...
      // THEN
      expect(service.find).toBeCalledWith(123);
      expect(resultVillageMaster).toEqual(undefined);
