...
export class CropMasterComponent implements OnInit {
  ...
  delete(cropMaster: ICropMaster): void {
    const modalRef = this.modalService.open(CropMasterDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.cropMasters = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICropMaster[] | null): ICropMaster[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.cropMasterService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
