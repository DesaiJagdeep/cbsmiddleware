...
describe('ActivityType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'activity-type', component: ActivityTypeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.activityTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to activityTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getActivityTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getActivityTypeIdentifier).toHaveBeenCalledWith(entity);
