 ...
 */
@Entity
@Table(name = "iss_file_parser_temp")
//@SuppressWarnings("common-java:DuplicatedBlocks")
public class IssFileParserTemp extends AbstractAuditingEntity<Long> implements Serializable {
    ...
    public IssFileParserTemp id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public IssFileParserTemp financialYear(String financialYear) {
    ...
    public IssFileParserTemp bankName(String bankName) {
    ...
    public IssFileParserTemp bankCode(String bankCode) {
    ...
    public IssFileParserTemp branchName(String branchName) {
    ...
    public IssFileParserTemp branchCode(String branchCode) {
    ...
    public IssFileParserTemp schemeWiseBranchCode(String schemeWiseBranchCode) {
    ...
    public IssFileParserTemp ifsc(String ifsc) {
        this.setIfsc(ifsc);
        return this;
    }
    ...
    public IssFileParserTemp loanAccountNumberkcc(String loanAccountNumberkcc) {
    ...
    public IssFileParserTemp farmerName(String farmerName) {
    ...
    public IssFileParserTemp gender(String gender) {
    ...
    public IssFileParserTemp aadharNumber(String aadharNumber) {
    ...
    public IssFileParserTemp dateofBirth(String dateofBirth) {
    ...
    public IssFileParserTemp ageAtTimeOfSanction(String ageAtTimeOfSanction) {
    ...
    public IssFileParserTemp mobileNo(String mobileNo) {
    ...
    public IssFileParserTemp farmersCategory(String farmersCategory) {
    ...
    public IssFileParserTemp farmerType(String farmerType) {
    ...
    public IssFileParserTemp socialCategory(String socialCategory) {
    ...
    public IssFileParserTemp relativeType(String relativeType) {
    ...
    public IssFileParserTemp relativeName(String relativeName) {
    ...
    public IssFileParserTemp stateName(String stateName) {
    ...
    public IssFileParserTemp stateCode(String stateCode) {
    ...
    public IssFileParserTemp districtName(String districtName) {
    ...
    public IssFileParserTemp districtCode(String districtCode) {
    ...
    public IssFileParserTemp blockCode(String blockCode) {
    ...
    public IssFileParserTemp blockName(String blockName) {
    ...
    public IssFileParserTemp villageCode(String villageCode) {
    ...
    public IssFileParserTemp villageName(String villageName) {
    ...
    public IssFileParserTemp address(String address) {
    ...
    public IssFileParserTemp pinCode(String pinCode) {
    ...
    public IssFileParserTemp accountType(String accountType) {
    ...
    public IssFileParserTemp accountNumber(String accountNumber) {
    ...
    public IssFileParserTemp pacsName(String pacsName) {
    ...
    public IssFileParserTemp pacsNumber(String pacsNumber) {
    ...
    public IssFileParserTemp accountHolderType(String accountHolderType) {
    ...
    public IssFileParserTemp primaryOccupation(String primaryOccupation) {
    ...
    public IssFileParserTemp loanSactionDate(String loanSactionDate) {
    ...
    public IssFileParserTemp loanSanctionAmount(String loanSanctionAmount) {
    ...
    public IssFileParserTemp tenureOFLoan(String tenureOFLoan) {
    ...
    public IssFileParserTemp dateOfOverDuePayment(String dateOfOverDuePayment) {
    ...
    public IssFileParserTemp cropName(String cropName) {
    ...
    public IssFileParserTemp surveyNo(String surveyNo) {
    ...
    public IssFileParserTemp satBaraSubsurveyNo(String satBaraSubsurveyNo) {
    ...
    public IssFileParserTemp seasonName(String seasonName) {
    ...
    public IssFileParserTemp areaHect(String areaHect) {
    ...
    public IssFileParserTemp landType(String landType) {
    ...
    public IssFileParserTemp disbursementDate(String disbursementDate) {
    ...
    public IssFileParserTemp disburseAmount(String disburseAmount) {
    ...
    public IssFileParserTemp maturityLoanDate(String maturityLoanDate) {
    ...
    public IssFileParserTemp recoveryAmountPrinciple(String recoveryAmountPrinciple) {
    ...
    public IssFileParserTemp recoveryAmountInterest(String recoveryAmountInterest) {
    ...
    public IssFileParserTemp recoveryDate(String recoveryDate) {
    ...
    public IssFileParserTemp issPortalFile(IssPortalFile issPortalFile) {
    ...
    public boolean isDuplicate(IssFileParserTemp other) {
        return this.loanAccountNumberkcc.equals(other.loanAccountNumberkcc);
    }

    public boolean isDuplicateApp(IssFileParserTemp other) {
        return (
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IssFileParserTemp)) {
            return false;
        }
        return id != null && id.equals(((IssFileParserTemp) o).id);
    }
    ...
    public String toString() {
        return "IssFileParserTemp{" + "id=" + getId() +
