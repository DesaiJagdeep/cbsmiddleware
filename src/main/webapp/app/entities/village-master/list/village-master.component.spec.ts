...
describe('VillageMaster Management Component', () => {
  let comp: VillageMasterComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(VillageMasterComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.villageMasters?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to villageMasterService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getVillageMasterIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getVillageMasterIdentifier).toHaveBeenCalledWith(entity);
